...
* 타입들이 하나 이상의 protocol를 준수할(conform) 수 있기 때문에, 여러개의 protocol 들로 부터의 기본 동작을 가지고 장식될(decorated) 수 있습니다. 몇몇 언어들이 제공하는 다중 상속과는 다르게, protocol 확장은 추가적인 속성(state)들이 추가되지 않습니다.
